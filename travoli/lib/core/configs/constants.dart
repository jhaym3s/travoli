...
const String kDummyEmail = "jhaym3s@gmail.com";
const String kDummyPassword = "Password#123";
const String kCurrency = '\u20A6';

const String kFontFamily = "SFPRODISPLAY";
